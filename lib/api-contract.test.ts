...
expectType<Promise<SandboxConfig[]>>(listSandboxConfigs());
expectType<Promise<SandboxConfig | undefined>>(getSandboxConfigDetail(1));
expectType<Promise<SandboxConfig | undefined>>(
  createSandboxConfig({
    binds: [],
...
expectType<Promise<void>>(deleteSandboxConfig(1));
